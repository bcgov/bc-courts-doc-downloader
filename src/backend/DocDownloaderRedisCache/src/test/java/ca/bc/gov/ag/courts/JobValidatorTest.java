...
public class JobValidatorTest {
    ...
    public void testValidateJobDatesWithValidDates() {
        Job job = new Job();
        job.setStartDelivery("2024-01-19T19:00:00-07:00");
        job.setEndDelivery("2024-01-20T19:00:00-07:00");
    ...
    public void testValidateJobDatesWithInvalidDates() {
        Job job = new Job();
        job.setStartDelivery("2024-01-19T19:00");
        job.setEndDelivery("2024-01-20T19:00");
