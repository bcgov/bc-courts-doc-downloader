...
/**
 * 
 * ORDS Document Service Unit tests. 
 * 
 * 
 * @author 176899
 *
...
public class OrdsDocumentServiceImplTests {
	
	Logger logger = LoggerFactory.getLogger(OrdsDocumentServiceImplTests.class);
	
	private MockMvc mockMvc;
	
	@InjectMocks
	private MSGraphServiceImpl mService;
